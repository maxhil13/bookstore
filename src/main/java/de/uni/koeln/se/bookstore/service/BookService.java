...
public class BookService {
    ...
    public Optional<Book> findTheOldestBook() {
        return bookRepo.findTopByOrderByYearAsc();
    }

    public Optional<Book> findTheNewestBook() {
        return bookRepo.findTopByOrderByYearDesc();
    }
}
